// https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/clients/client-ec2/classes/stopinstancescommand.html
...
const doPostRequest = (record) => {
    const data = {
        text: "I stoped these EC2 instances with IDs: `" + record + "` due to overworking hour",
